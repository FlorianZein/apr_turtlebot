...
int main(int argc, char *argv[])
{
    ...
    unsigned short echoServPort = 9997;     /*  server port */
    ...
    while(true)
    {
        ...
        // extract laser data from received string
        scanExtract();

        // sending extracted laser data
...
void scanExtract()
{   
    // extracting data over substringing the received string and fill it into an array 
